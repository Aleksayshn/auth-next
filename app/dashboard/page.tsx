  ...
  return (
    <main className="relative min-h-screen overflow-hidden bg-page-bg px-6 py-10 text-page-foreground">
      <div className="pointer-events-none absolute inset-0">
        <div className="absolute inset-x-[-10%] top-[-12%] h-[32rem] rounded-full bg-[radial-gradient(circle_at_center,_rgba(175,52,24,0.24),_rgba(55,120,215,0.06)_55%,_transparent_80%)] blur-3xl" />
      </div>
      <div className="relative mx-auto flex min-h-[calc(100vh-5rem)] max-w-5xl items-center justify-center">
        <section className="w-full max-w-2xl rounded-[2rem] border border-white/8 bg-white/[0.04] p-8 shadow-[0_30px_90px_rgba(0,0,0,0.45)] backdrop-blur-2xl sm:p-12">
          ...
          <div className="mt-10 flex flex-wrap gap-3">
            ...
            <a
              ...
              className="inline-flex h-12 items-center justify-center rounded-full border border-white/12 bg-white/[0.03] px-6 text-sm font-medium text-white/76 transition-colors duration-200 hover:bg-white/[0.06]"
            >
              Contact support
            </a>
          </div>
